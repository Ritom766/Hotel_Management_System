...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container-box">
            <h3>Add New Hotel Branch</h3>
            <form action="#" method="POST" class="form-grid">
                <div class="form-group">
                    <label>Hotel ID (e.g. H0001)</label>
                    <input type="text" name="HotelID" maxlength="6" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="StarRating" min="1" max="5" required>
                </div>
                <div class="form-group" style="grid-column: 1 / -1;">
                    <label>Address</label>
                    <input type="text" name="Address" required>
                </div>
                <button type="button" class="btn" onclick="alert('Hotel Added Successfully!')">Save Hotel</button>
            </form>
        </div>
